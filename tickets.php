...
<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
    ...
    <h5 class="d-none d-sm-inline-block m-0 text-gray-800 font-weight-bold">Tickets</h5>
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <!-- TODO -->
    <a href=".php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
        <i class="fas fa-ticket-alt fa-sm text-white-50"></i></i> Issue Ticket
    </a>
</div>
