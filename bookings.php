...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <!-- TODO -->
    <a href="booking_form.php" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">
        <i class="fas fa-calendar-plus fa-sm text-white-50"></i> Create Booking
    </a>
</div>
